-- Fix the handle_new_user_signup function to use correct column name for activity_logs
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        -- 5. Log the organization creation activity using correct column names
        INSERT INTO public.activity_logs (
            organization_id,
            actor_user_id,  -- Changed from user_id to actor_user_id
            actor_role_snapshot,
            action,
            target_type,
            target_id,
