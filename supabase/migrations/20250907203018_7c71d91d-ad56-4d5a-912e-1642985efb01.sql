-- Permanently remove Core plan definitions (idempotent, duplicate of previous migration)
...
BEGIN
    ...
    IF v_org_id IS NOT NULL THEN
        ...
        RAISE NOTICE 'Core plan cleanup v2 audit logged for org_id: %', v_org_id;
    ELSE
        RAISE NOTICE 'Skipping core plan cleanup v2 audit log: no organizations exist yet';
    END IF;
END $$;
