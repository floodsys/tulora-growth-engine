-- Fix the handle_new_user_signup function to use a valid target_type for activity_logs
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        -- 5. Log the organization creation activity (skip for now to avoid constraint issues)
        -- We'll use the log_activity function instead which might have different validation
