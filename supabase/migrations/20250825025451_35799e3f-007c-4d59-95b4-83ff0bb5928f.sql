-- Fix the handle_new_user_signup function to use a valid status for agent_profiles
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        -- 4. Seed one sample agent with 'active' status (since 'draft' is not valid)
...
-- Also fix the setup_user_account function
