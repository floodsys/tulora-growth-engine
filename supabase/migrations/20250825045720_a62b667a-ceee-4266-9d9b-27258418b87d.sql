...
-- Update retention caps and create improved cleanup function
...
DECLARE
  ...
  export_data jsonb;
  bucket_name text := 'retention-exports';
BEGIN
  ...
  LOOP
    ...
    IF (org_record.export_before_purge->>'audit')::boolean THEN
      ...
      IF export_data IS NOT NULL THEN
        -- Store export in storage bucket (this would typically be done via edge function)
