  ...
  const agents = [
    {
      ...
      features: [
        { icon: "📧", title: "No cold leads", subtitle: "Every follow-up handled" },
        { icon: "⚡", title: "Speed to lead", subtitle: "Instant, every time" },
        { icon: "💼", title: "Less admin", subtitle: "AI handles it" },
        { icon: "👥", title: "Custom flows", subtitle: "Built for you" },
        { icon: "🔗", title: "Integration", subtitle: "Works anywhere" }
      ]
    },
    {
      ...
      features: [
        { icon: "🔍", title: "Deep insights", subtitle: "Comprehensive research" },
        { icon: "📊", title: "Smart analysis", subtitle: "AI-powered findings" },
        { icon: "⏰", title: "Save time", subtitle: "Instant results" },
        { icon: "🎯", title: "Targeted data", subtitle: "Relevant only" },
        { icon: "📋", title: "Ready reports", subtitle: "Formatted" }
      ]
    },
    {
      title: "Support Agent",
      ...
      descriptions: [
        ...
        "Learns from your knowledge base and documents",
        "Escalates complex issues to human agents seamlessly"
      ],
      features: [
        { icon: "💬", title: "24/7 available", subtitle: "Always online" },
        { icon: "🧠", title: "Smart learning", subtitle: "Improves over time" },
        { icon: "🎧", title: "Multi-channel", subtitle: "Chat, email, phone" },
        { icon: "🔄", title: "Smart handoff", subtitle: "Knows when" },
        { icon: "📈", title: "Track metrics", subtitle: "Monitor performance" }
      ]
    },
    {
      title: "Content Agent",
      emoji: "✏️",
      descriptions: [
        "Creates blog posts, emails, and marketing copy",
        "Maintains your brand voice and style consistently",
        "Optimizes content for SEO and engagement"
      ],
      features: [
        { icon: "✏️", title: "Brand voice", subtitle: "Matches yours" },
        { icon: "🚀", title: "SEO ready", subtitle: "Built for discovery" },
        { icon: "📝", title: "Multi-format", subtitle: "Blogs, emails, social" },
        { icon: "📊", title: "Track results", subtitle: "Measure engagement" },
        { icon: "⚡", title: "Fast output", subtitle: "Content at scale" }
      ]
    }
  ];
    ...
    <section className="pt-8 pb-20 bg-background">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="mb-5">
            <img 
              src="https://71bed9839f6b63de0d12cd02f4fd4947.cdn.bubble.io/f1754095697336x643713194993545500/ai_workforce.svg" 
              alt="AI Workforce" 
              className="w-48 h-28 mx-auto"
            />
          </div>
          <h2 className="text-5xl font-bold text-foreground mb-4 font-heading">
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="space-y-1 mb-3">
                  {agent.descriptions.map((desc, idx) => (
                ...
                <div className="grid grid-cols-3 lg:grid-cols-5 gap-2 mt-2">
                  {agent.features.map((feature, idx) => (
                    <div 
                      key={idx}
                      className="bg-muted/50 p-2 rounded-lg border border-border/50 text-center transition-all duration-200 hover:bg-muted hover:border-border"
                    >
