  ...
  const plans = [
    {
      ...
      features: [
        "50 AI-generated messages/month",
    ...
    {
      name: "Pro", 
      price: { monthly: 89, yearly: 712 }, // $712 = $89 * 12 * 0.67 (33% discount)
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative card-glass p-8 ${
                plan.popular ? "ring-2 ring-brand shadow-brand" : ""
              }`}
            >
              {plan.popular && (
