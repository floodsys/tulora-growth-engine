...
import { Phone, Monitor, Loader2, Copy, ChevronDown, Clock, AlertTriangle } from "lucide-react";
...
export function TestCallsTab({ selectedAgent: initialAgent }: TestCallsTabProps = {}) {
  ...
  const handleCallMe = async () => {
    ...
    try {
      ...
      // Check for billing limit error first
      ...
      if (isBillingQuotaCheckError(error)) {
