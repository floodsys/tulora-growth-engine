...
const LiveDemo = () => {
  ...
  const resetDemo = () => {
    setDemoStep(0);
    setFormData({ prospect: "", company: "", product: "", message: "" });
  };
            ...
            <div className="card-glass p-8">
              ...
              <div className="space-y-6">
                ...
                <Button 
                  ...
                  disabled={!formData.prospect || !formData.company || !formData.product}
                >
                  Generate AI Message
                </Button>
              </div>
                ...
                <div className="space-y-6 animate-fade-in">
                  <div className="bg-background-secondary rounded-lg p-4">
                    ...
                    <p className="text-sm leading-relaxed">
                      ...
                      {formData.product === "crm" ? " managing customer relationships at scale" :
                       formData.product === "marketing" ? " coordinating marketing campaigns across teams" :
                       formData.product === "sales" ? " streamlining their sales processes" :
                       " making sense of their data"}.<br/><br/>
