...
import { Users, UserPlus, Mail, MoreHorizontal, Trash2 } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function TeamSettings({ organizationId }: TeamSettingsProps) {
  ...
  const loadTeamMembers = async () => {
    ...
    try {
      ...
      // Mock additional user data since we can't join with auth.users
  ...
  const inviteTeamMember = async () => {
    ...
    setInviting(true);
    try {
      // This would normally create an invitation record
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(role) => setInviteData(prev => ({ ...prev, role: role as 'admin' | 'editor' | 'viewer' | 'user' }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
