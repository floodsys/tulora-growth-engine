const AIWorkforceHero = () => {
  return <section className="relative py-8 bg-background overflow-hidden min-h-[400px] flex items-center justify-center">
      {/* Floating Shapes */}
      ...
      <div className="relative z-10 max-w-4xl text-center px-5">
        {/* Badge Image */}
        <img src="https://71bed9839f6b63de0d12cd02f4fd4947.cdn.bubble.io/f1754095693611x295787058622864830/who_its_for.svg" alt="Who's it for" className="w-52 h-auto mx-auto mb-5" />
