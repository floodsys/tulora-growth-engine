const AIWorkforceHero = () => {
  return <section className="relative py-0 bg-background overflow-hidden min-h-0 flex items-center justify-center -mt-4">
      ...
      <div className="relative z-10 max-w-4xl text-center px-5">
        ...
        <img src="https://71bed9839f6b63de0d12cd02f4fd4947.cdn.bubble.io/f1754095693611x295787058622864830/who_its_for.svg" alt="Who's it for" className="w-48 h-28 mx-auto mb-5 absolute -top-14 left-1/2 transform -translate-x-1/2" />
